## Mapping
* We are familiar with the ` map ` function used with **arrays** to apply a specific **function** on each element and return a new array of the result.
```js
var numbers = [1, 2, 3, 4];
